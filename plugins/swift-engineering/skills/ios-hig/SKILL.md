...
| **[Accessibility](references/accessibility.md)** | VoiceOver, Dynamic Type, Reduce Motion, or accessibility labels (quick summary — deep accessibility lives in the dedicated `accessibility` skill) |
