...
- **Knowledge Skills** — 35 specialized knowledge bases covering architecture patterns, adaptive UI, macOS multiplatform, SwiftData & persistence, App Intents/widgets, networking, animations, charts, security, observability, performance profiling, release/CI-CD, frameworks, AI-feature evaluation, design principles, accessibility, performance monitoring, and development tools
...
│       ├── skills/                         # 35 comprehensive skills
