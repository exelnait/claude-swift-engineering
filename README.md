...
- **Knowledge Skills** — 33 specialized knowledge bases covering architecture patterns, adaptive UI, macOS multiplatform, SwiftData & persistence, App Intents/widgets, networking, animations, charts, security, observability, frameworks, AI-feature evaluation, design principles, accessibility, performance monitoring, and development tools
...
│       ├── skills/                         # 33 comprehensive skills
