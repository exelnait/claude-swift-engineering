...
| **Implementation** | @feature-engineer, @tca-engineer, @swiftui-specialist, @accessibility-specialist, @swift-test-creator, @evaluation-engineer, @architecture-keeper, @swift-code-reviewer, @swift-modernizer | Code creation, accessibility, AI-feature evaluation, and review (Sonnet) |
...
- **Model Stratification** — Opus 4.8 for architecture (best reasoning), Sonnet 5 for implementation (strong coding at lower cost), Haiku for utilities (fast)
